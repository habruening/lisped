...
(defparameter +esc-and-f-key-names+ '(ESC F1 F2 F3 F4 F5 F6 F7 F8 F9 F10 F11 F12))

;;; The icon for keys that are not active
(defparameter +empty-key-icon+ "icons/empty.png")

;;; The default configuration of the f-key-toolbar
(defparameter +esc-and-f-keys-definitions+
  (list (cons 'startup (list (cons 'ESC  (make-key-button-definition :icon-file "icons/empty.png"
